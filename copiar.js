...
// Tu configuración de Firebase (pon aquí la tuya)
...
resultadoForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    estadoGuardado.textContent = "Resultados guardados correctamente.";
  } catch (error) {
    console.error("Error guardando resultado:", error);
    estadoGuardado.textContent = "Error al guardar los resultados.";
  }
});
